...
@rem ##########################################################################
@rem
@rem  client_part startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CLIENT_PART_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_PART_OPTS%  -classpath "%CLASSPATH%"  %*
...
:fail
rem Set variable CLIENT_PART_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CLIENT_PART_EXIT_CONSOLE%" exit 1
exit /b 1
